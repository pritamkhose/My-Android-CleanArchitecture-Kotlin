...
import com.fernandocejas.sample.features.movies.repository.MoviesRepository.Network
...
import com.fernandocejas.sample.features.movies.model.Movie
import com.fernandocejas.sample.features.movies.model.MovieDetails
import com.fernandocejas.sample.features.movies.model.MovieDetailsEntity
import com.fernandocejas.sample.features.movies.model.MovieEntity
import com.fernandocejas.sample.features.movies.repository.MoviesRepository
import com.fernandocejas.sample.features.movies.service.MoviesService
...
class MoviesRepositoryTest : UnitTest() {
    ...
    @Test fun `should get movie details from service`() {
        ...
        movieDetails shouldEqual Right(
            MovieDetails(8, "title", String.empty(), String.empty(),
                String.empty(), String.empty(), 0, String.empty())
        )
        verify(service).movieDetails(1)
    }
